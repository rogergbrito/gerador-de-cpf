...
var GeraCPF = /*#__PURE__*/function () {
  ...
  _createClass(GeraCPF, [{
    ...
    value: function rand() {
      ...
      // gera um numero aleatorio de 9 dígitos
      return String(Math.floor(Math.random() * (max - min) + min));
    }
  }, {
    key: "formatado",
    value: function formatado(cpf) {
      return cpf.slice(0, 3) + '.' + // adiciona um ponto a cada 3 dígitos
      cpf.slice(3, 6) + '.' + cpf.slice(6, 9) + '-' + cpf.slice(9, 11);
    }
  }, {
    key: "geraNovoCpf",
    value: function geraNovoCpf() {
      var cpfSemDigitos = this.rand(); // cpfSemDigitos armazena o número aleatorio de 9 digitos

      var digito1 = _ValidaCPF__WEBPACK_IMPORTED_MODULE_0__["default"].geraDigito(cpfSemDigitos); // usa o método importado do ValidaCPF que gera o digito 1 e 2
...
(function () {
  // função auto executável, basta colocar entre parênteses e chamar os parênteses de novo no final
